#!/usr/bin/env python3
"""Download lombardprof30 (1C:Ломбард ПРОФ 3.0) documentation from ITS and convert to clean text.

Same flow as download_docs.py (v851doc): /db/lombardprof30/content/NN/hdoc?bus
returns JSON with iframe src pointing to /db/content/lombardprof30/.../*.htm.
"""
...
DOCS_DIR = os.path.join(REPO_ROOT, "docs", "lombardprof30")
BASE = "https://its.1c.ru"
URLS_FILE = os.path.join(SCRIPT_DIR, "lombardprof30_urls.txt")
